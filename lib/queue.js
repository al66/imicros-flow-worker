    ...
    actions: {
        ...
        add: {
            ...
            async handler(ctx) {
                ...
                let query = "INSERT INTO " + this.contextTable + " (owner,service,idx,value,oek,iv) VALUES (:owner,:service,:idx,:value,:oek,:iv);";
                let params = { 
                    owner, 
    ...
    methods: {
        ...
        async connect () {
            ...
            */
            ...
            query += " ( owner varchar, service uuid, idx varchar, value varchar, oek uuid, iv varchar, PRIMARY KEY (owner,service,idx) ) ";
