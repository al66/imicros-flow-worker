    ...
    actions: {
        ...
        ack: {
            ...
            async handler(ctx) {
                ...
                let index = await this.getCurrent({ owner: ownerId, serviceId: ctx.params.serviceId, workerId: ctx.params.workerId });
                ...
                try {
                    let result = await this.ack({ owner: ownerId, serviceId: ctx.params.serviceId, workerId: ctx.params.workerId });
                    // given token ?
        ...
        rewind: {
            ...
            async handler(ctx) {
                ...
                try {
                    let result = await this.rewind({ owner: ownerId, serviceId: ctx.params.serviceId, last: `${ctx.params.last}` });
                    return result;
                } catch (err) /* istanbul ignore next */ {
        ...
        info: {
            ...
            async handler(ctx) {
                ...
                try {
                    let result = await this.info({ owner: ownerId, serviceId: ctx.params.serviceId });
                    return result;
                } catch (err) /* istanbul ignore next */ {
